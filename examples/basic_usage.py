...
print("Motor2:")
print("PMAX:", motor_control.read_motor_param(motor2, MotorReg.PMAX))
print("MST_ID:", motor_control.read_motor_param(motor2, MotorReg.MST_ID))
print("VMAX:", motor_control.read_motor_param(motor2, MotorReg.VMAX))
print("TMAX:", motor_control.read_motor_param(motor2, MotorReg.TMAX))
